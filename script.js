document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==================================================================
    const SUPABASE_URL = 'https://egishguoptqbxmsnhngf.supabase.co'; // Substitua se o ID do projeto for outro
    ...
    _supabase.auth.onAuthStateChange(async (event, session) => {
        if (session && session.user) {
            ...
            // Esconde cadastro/apresentação se estiver logado
    ...
    const renderTasks = () => {
        ...
        if (!activeProject) {
            taskCounter.textContent = 'Crie ou selecione um projeto.';
            return;
        }
